...
const blogPosts: BlogPost[] = [
  {
    ...
    excerpt:
      "Learn the biomechanics behind a powerful serve and discover drills that will transform your game from the service line.",
    author: "Luc Tremblay",
    authorShort: "Luc T.",
    date: "Dec 28, 2024",
    dateShort: "Dec 28",
  ...
  },
  {
    ...
    excerpt:
      "Discover proven strategies to help your child develop resilience, confidence, and a winning mindset on and off the court.",
    author: "Luc Tremblay",
    authorShort: "Luc T.",
    date: "Dec 25, 2024",
    dateShort: "Dec 25",
  ...
  },
  {
    ...
    excerpt:
      "Fuel your game with expert nutrition advice tailored specifically for volleyball players at every level.",
    author: "Luc Tremblay",
    authorShort: "Luc T.",
    date: "Dec 22, 2024",
    dateShort: "Dec 22",
  ...
  },
  {
    ...
    excerpt:
      "Follow one parent's inspiring story of supporting their daughter's volleyball dreams from grassroots to collegiate success.",
    author: "Luc Tremblay",
    authorShort: "Luc T.",
    date: "Dec 20, 2024",
    dateShort: "Dec 20",
                        ...
                        <div className="flex items-center gap-1.5 sm:gap-2 text-[11px] sm:text-sm text-gray-500 dark:text-gray-500">
                          ...
                          <div className="flex items-center gap-0.5 sm:gap-1">
                            ...
                            <span className="max-w-[80px] sm:max-w-none truncate">
                              <span className="sm:hidden">
                                {post.authorShort || post.author.split(" ")[0]}
                              </span>
                              <span className="hidden sm:inline">
                                {post.author}
                              </span>
