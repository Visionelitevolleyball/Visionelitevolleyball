  ...
  return (
    <section className={cn(
      ...
      <div className="relative">
        ...
        <div className="flex overflow-hidden mb-6 [--gap:1.5rem] [--duration:60s]">
        ...
        <div className="flex overflow-hidden [--gap:1.5rem] [--duration:60s]">
          <div className="flex shrink-0 justify-around gap-6 animate-marquee-reverse">
